...
export const COLOR_CUBE_JUMPER = 0x4488ff;
export const COLOR_CUBE_ZIGZAG = 0x44ff66;
export const COLOR_CUBE_TELEPORTER = 0xcc44ff;
export const COLOR_CUBE_TANK = 0x888899;
export const COLOR_CUBE_CHARGER = 0xffdd00;
